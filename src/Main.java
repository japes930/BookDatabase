...
//        Adding objects to arrayList
        ...
        switch(input) {
            case "Java1001":
                System.out.println(Books.get(0).getDisplayText());
                break;
            case "Java1002":
                System.out.println(Books.get(1).getDisplayText());
                break;
            case "Orcl1003":
                System.out.println(Books.get(2).getDisplayText());
                break;
            case "Python1004":
                System.out.println(Books.get(3).getDisplayText());
                break;
            case "Zombie1005":
                System.out.println(Books.get(4).getDisplayText());
                break;
            case "Rasp1006":
                System.out.println(Books.get(5).getDisplayText());
                break;
        }
//        BookBySku book = new BookBySku(1001);
